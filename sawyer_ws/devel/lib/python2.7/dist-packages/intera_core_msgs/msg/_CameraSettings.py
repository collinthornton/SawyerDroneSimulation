...
"""autogenerated by genpy from intera_core_msgs/CameraSettings.msg. Do not edit."""
import sys
...
class CameraSettings(genpy.Message):
  ...
  _type = "intera_core_msgs/CameraSettings"
...
"""
  ...
  _slot_types = ['int32','int32','float32','intera_core_msgs/CameraControl[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = intera_core_msgs.msg.CameraControl()
        _x = val1
        start = end
        end += 8
