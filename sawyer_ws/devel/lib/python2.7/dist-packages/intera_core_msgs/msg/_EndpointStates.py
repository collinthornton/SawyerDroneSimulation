...
"""autogenerated by genpy from intera_core_msgs/EndpointStates.msg. Do not edit."""
import sys
...
class EndpointStates(genpy.Message):
  _md5sum = "d7b5ea85d8388c002e6c6d800ba697bc"
  _type = "intera_core_msgs/EndpointStates"
...
Vector3  torque
"""
  __slots__ = ['header','names','states']
  _slot_types = ['std_msgs/Header','string[]','intera_core_msgs/EndpointState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = intera_core_msgs.msg.EndpointState()
        _v12 = val1.header
        start = end
        end += 4
