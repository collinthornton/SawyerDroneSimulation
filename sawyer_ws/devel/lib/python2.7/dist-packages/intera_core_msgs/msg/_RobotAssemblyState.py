...
"""autogenerated by genpy from intera_core_msgs/RobotAssemblyState.msg. Do not edit."""
import sys
...
class RobotAssemblyState(genpy.Message):
  _md5sum = "df79ce5f75a6b23626e9fcdf1cc4d298"
  _type = "intera_core_msgs/RobotAssemblyState"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool homed               # true if all joints are homed
...
"""
  ...
  __slots__ = ['homed','ready','enabled','stopped','error','lowVoltage','estop_button','estop_source']
  _slot_types = ['bool','bool','bool','bool','bool','bool','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       homed,ready,enabled,stopped,error,lowVoltage,estop_button,estop_source
    ...
    """
    if args or kwds:
      super(RobotAssemblyState, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_8B().pack(_x.homed, _x.ready, _x.enabled, _x.stopped, _x.error, _x.lowVoltage, _x.estop_button, _x.estop_source))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.homed, _x.ready, _x.enabled, _x.stopped, _x.error, _x.lowVoltage, _x.estop_button, _x.estop_source,) = _get_struct_8B().unpack(str[start:end])
      self.homed = bool(self.homed)
      self.ready = bool(self.ready)
      self.enabled = bool(self.enabled)
      self.stopped = bool(self.stopped)
      self.error = bool(self.error)
      self.lowVoltage = bool(self.lowVoltage)
      return self
