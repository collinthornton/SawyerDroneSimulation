...
"""autogenerated by genpy from intera_core_msgs/CalibrationCommandAction.msg. Do not edit."""
import sys
...
class CalibrationCommandAction(genpy.Message):
  _md5sum = "4918e674f484b978148ca2521979946d"
  _type = "intera_core_msgs/CalibrationCommandAction"
...
"""
  ...
  _slot_types = ['intera_core_msgs/CalibrationCommandActionGoal','intera_core_msgs/CalibrationCommandActionResult','intera_core_msgs/CalibrationCommandActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalibrationCommandAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = intera_core_msgs.msg.CalibrationCommandActionGoal()
      if self.action_result is None:
        self.action_result = intera_core_msgs.msg.CalibrationCommandActionResult()
      if self.action_feedback is None:
        self.action_feedback = intera_core_msgs.msg.CalibrationCommandActionFeedback()
    else:
      self.action_goal = intera_core_msgs.msg.CalibrationCommandActionGoal()
      self.action_result = intera_core_msgs.msg.CalibrationCommandActionResult()
      self.action_feedback = intera_core_msgs.msg.CalibrationCommandActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_result.result.statusId
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_feedback.feedback.numberOfPoses, _x.action_feedback.feedback.currentPoseNumber))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.statusId = str[start:end].decode('utf-8')
      else:
        self.action_result.result.statusId = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.currentState = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.currentState = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.action_feedback.feedback.numberOfPoses, _x.action_feedback.feedback.currentPoseNumber,) = _get_struct_2I().unpack(str[start:end])
      return self
