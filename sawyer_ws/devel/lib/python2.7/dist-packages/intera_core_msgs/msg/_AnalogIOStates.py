...
"""autogenerated by genpy from intera_core_msgs/AnalogIOStates.msg. Do not edit."""
import sys
...
class AnalogIOStates(genpy.Message):
  ...
  _type = "intera_core_msgs/AnalogIOStates"
...
"""
  ...
  _slot_types = ['string[]','intera_core_msgs/AnalogIOState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = intera_core_msgs.msg.AnalogIOState()
        _v2 = val1.timestamp
        _x = _v2
        start = end
        end += 8
