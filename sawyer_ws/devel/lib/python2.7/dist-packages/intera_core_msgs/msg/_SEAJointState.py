...
"""autogenerated by genpy from intera_core_msgs/SEAJointState.msg. Do not edit."""
import sys
...
class SEAJointState(genpy.Message):
  _md5sum = "5df7bfe6612daccc934b34dad7800762"
  _type = "intera_core_msgs/SEAJointState"
...
string frame_id
"""
  __slots__ = ['header','name','commanded_position','commanded_velocity','commanded_acceleration','commanded_effort','actual_position','actual_velocity','actual_effort','gravity_model_effort','gravity_only','interaction_torque','hysteresis_model_effort','crosstalk_model_effort','hystState']
  _slot_types = ['std_msgs/Header','string[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,commanded_position,commanded_velocity,commanded_acceleration,commanded_effort,actual_position,actual_velocity,actual_effort,gravity_model_effort,gravity_only,interaction_torque,hysteresis_model_effort,crosstalk_model_effort,hystState
    ...
    if args or kwds:
      ...
      if self.gravity_only is None:
        self.gravity_only = []
      if self.interaction_torque is None:
        self.interaction_torque = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.interaction_torque)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.interaction_torque))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.interaction_torque = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.interaction_torque.tostring())
      length = len(self.hysteresis_model_effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.interaction_torque = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
