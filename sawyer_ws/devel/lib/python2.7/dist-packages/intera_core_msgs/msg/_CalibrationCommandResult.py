...
"""autogenerated by genpy from intera_core_msgs/CalibrationCommandResult.msg. Do not edit."""
import sys
...
class CalibrationCommandResult(genpy.Message):
  _md5sum = "42762277c2f2777e046b77cebb5b2b55"
  _type = "intera_core_msgs/CalibrationCommandResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalibrationCommandResult, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.statusId = str[start:end].decode('utf-8')
      else:
        self.statusId = str[start:end]
      return self
