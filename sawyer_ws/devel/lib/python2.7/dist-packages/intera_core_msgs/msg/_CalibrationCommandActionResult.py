...
"""autogenerated by genpy from intera_core_msgs/CalibrationCommandActionResult.msg. Do not edit."""
import sys
...
class CalibrationCommandActionResult(genpy.Message):
  _md5sum = "7bbdad167cfc1ba74f984710e7e50ea4"
  _type = "intera_core_msgs/CalibrationCommandActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','intera_core_msgs/CalibrationCommandResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CalibrationCommandActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = intera_core_msgs.msg.CalibrationCommandResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = intera_core_msgs.msg.CalibrationCommandResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.statusId = str[start:end].decode('utf-8')
      else:
        self.result.statusId = str[start:end]
      return self
