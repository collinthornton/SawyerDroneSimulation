...
"""autogenerated by genpy from intera_core_msgs/IONodeConfiguration.msg. Do not edit."""
import sys
...
class IONodeConfiguration(genpy.Message):
  _md5sum = "66800b32dbb52df00e2454d58668ac33"
  _type = "intera_core_msgs/IONodeConfiguration"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# IO Node Configuration
...
"""
  __slots__ = ['time','node','devices','plugins']
  _slot_types = ['time','intera_core_msgs/IOComponentConfiguration','intera_core_msgs/IOComponentConfiguration[]','intera_core_msgs/IOComponentConfiguration[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IONodeConfiguration, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.time is None:
        self.time = genpy.Time()
      if self.node is None:
        self.node = intera_core_msgs.msg.IOComponentConfiguration()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.node.config = str[start:end].decode('utf-8')
      else:
        self.node.config = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.devices = []
