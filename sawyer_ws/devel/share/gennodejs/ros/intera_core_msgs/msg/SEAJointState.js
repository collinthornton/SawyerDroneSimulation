...
class SEAJointState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('interaction_torque')) {
        this.interaction_torque = initObj.interaction_torque
      }
      else {
        this.interaction_torque = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [interaction_torque]
    bufferOffset = _arraySerializer.float64(obj.interaction_torque, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [interaction_torque]
    data.interaction_torque = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.interaction_torque.length;
  ...
  static Resolve(msg) {
    ...
    if (msg.interaction_torque !== undefined) {
      resolved.interaction_torque = msg.interaction_torque;
    }
    else {
      resolved.interaction_torque = []
    }
