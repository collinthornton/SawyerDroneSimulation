...
class MotionCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MotionCommandFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MotionCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MotionCommandActionFeedback(null);
    ...
    data.feedback = MotionCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MotionCommandFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MotionCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MotionCommandFeedback()
    }
...
module.exports = MotionCommandActionFeedback;
