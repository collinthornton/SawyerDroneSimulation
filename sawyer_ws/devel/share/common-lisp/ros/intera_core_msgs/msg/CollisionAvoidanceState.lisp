...
(cl:defmethod cl:initialize-instance :after ((m <CollisionAvoidanceState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionAvoidanceState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<CollisionAvoidanceState> is deprecated: use intera_core_msgs-msg:CollisionAvoidanceState instead.")))
...
(cl:defmethod other_arm-val ((m <CollisionAvoidanceState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intera_core_msgs-msg:other_arm-val is deprecated.  Use intera_core_msgs-msg:other_arm instead.")
  (other_arm m))

(cl:ensure-generic-function 'collision_object-val :lambda-list '(m))
(cl:defmethod collision_object-val ((m <CollisionAvoidanceState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intera_core_msgs-msg:collision_object-val is deprecated.  Use intera_core_msgs-msg:collision_object instead.")
  (collision_object m))
