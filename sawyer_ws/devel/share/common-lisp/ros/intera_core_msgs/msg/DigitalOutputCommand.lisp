...
(cl:defmethod cl:initialize-instance :after ((m <DigitalOutputCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalOutputCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<DigitalOutputCommand> is deprecated: use intera_core_msgs-msg:DigitalOutputCommand instead.")))
