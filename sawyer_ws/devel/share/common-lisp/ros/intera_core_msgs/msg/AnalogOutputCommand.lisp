...
(cl:defmethod cl:initialize-instance :after ((m <AnalogOutputCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalogOutputCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<AnalogOutputCommand> is deprecated: use intera_core_msgs-msg:AnalogOutputCommand instead.")))
