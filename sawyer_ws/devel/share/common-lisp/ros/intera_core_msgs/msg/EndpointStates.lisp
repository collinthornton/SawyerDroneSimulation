...
(cl:defclass <EndpointStates> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector intera_core_msgs-msg:EndpointState)
   :initform (cl:make-array 0 :element-type 'intera_core_msgs-msg:EndpointState :initial-element (cl:make-instance 'intera_core_msgs-msg:EndpointState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EndpointStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<EndpointStates> is deprecated: use intera_core_msgs-msg:EndpointStates instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EndpointStates>))
...
(cl:defmethod names-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intera_core_msgs-msg:names-val is deprecated.  Use intera_core_msgs-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intera_core_msgs-msg:states-val is deprecated.  Use intera_core_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EndpointStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'intera_core_msgs-msg:EndpointState))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EndpointStates>)))
  ...
  "d7b5ea85d8388c002e6c6d800ba697bc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EndpointStates)))
  "Returns md5sum for a message object of type 'EndpointStates"
  "d7b5ea85d8388c002e6c6d800ba697bc")
