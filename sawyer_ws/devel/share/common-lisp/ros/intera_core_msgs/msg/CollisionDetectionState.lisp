...
(cl:defmethod cl:initialize-instance :after ((m <CollisionDetectionState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionDetectionState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intera_core_msgs-msg:<CollisionDetectionState> is deprecated: use intera_core_msgs-msg:CollisionDetectionState instead.")))
...
(cl:defmethod collision_state-val ((m <CollisionDetectionState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intera_core_msgs-msg:collision_state-val is deprecated.  Use intera_core_msgs-msg:collision_state instead.")
  (collision_state m))
